...
<div class="not-prose bg-amber-300 dark:bg-amber-600 text-black p-2 [&_a]:font-bold [&_a]:underline">
  An updated version of this article is available:
  
  [Passing data to a bundled script in Astro](/blog/passing-data-to-a-bundled-script-in-astro)
</div>

Have you found yourself in a situation where you needed to hydrate a global store,
